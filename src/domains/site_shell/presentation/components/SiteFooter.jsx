import { siblingSite, siteMeta, sponsor } from "@/domains/site_content/domain/content";
...
export default function SiteFooter() {
  return (
    <footer className="hurock-footer">
      <div className="hurock-footer-inner">
        <div>
          <p>
        ...
        <div className="hurock-footer-links">
          <a
            href={sponsor.url}
            target="_blank"
            rel="noreferrer"
