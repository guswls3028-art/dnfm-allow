...
import { hero, host, platforms } from "@/domains/site_content/domain/content";
...
export default function HeroBanner() {
  return (
    <section className="hurock-hero" aria-labelledby="hurock-hero-title">
      <div className="hurock-hero-copy">
        <span className="hurock-hero-kicker">{hero.kicker}</span>
        <h1 id="hurock-hero-title">
        ...
        <p className="hurock-hero-body">{hero.body}</p>
        <div className="hurock-hero-actions">
          {hero.primaryActions.map((action) => {
            ...
            if (action.note) {
              return (
                <span key={action.label} className="hurock-hero-action-stack">
                  {buttonEl}
      ...
      <div className="hurock-hero-portrait" aria-hidden="false">
        <div className="hurock-hero-portrait-inner">
          {host.avatarSrc ? (
            <span className="hurock-hero-portrait-avatar has-image">
              <Image
                src={host.avatarSrc}
            ...
            <span className="hurock-hero-portrait-avatar" />
          )}
