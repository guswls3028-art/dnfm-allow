...
import { ApiError, posts as postsApi } from "@/shared/api/api-client";
import { isAdmin, useCurrentUser } from "@/shared/auth/use-current-user";
import ImageUploader from "@/shared/ui/ImageUploader";
import PostComposerEditor from "@/features/board/components/PostComposerEditor";
...
export default function BoardEditScreen({ params }) {
  const { id } = use(params);
